...
//	刪除 
	...
	@DeleteMapping("/Store/wishList/delete")
	public String deleteWishlist(@RequestParam  Integer memberId,Integer commId) {
		System.out.println("memberId:"+memberId + "commId:"+commId);
		wishListService.deleteWishListByMemberAndCommodity(memberId, commId);
		return "redirect:/Store/wishList/readwishlist";
	}

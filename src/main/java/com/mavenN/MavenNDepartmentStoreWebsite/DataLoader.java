...
public class DataLoader implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Counter
		Counter counter1 = new Counter(1, "A", 60000, 50.5, "1");
		Counter counter2 = new Counter(2, "B", 50000, 40.0, "1");
		Counter counter3 = new Counter(3, "C", 60000, 50.5, "1");
		Counter counter4 = new Counter(4, "D", 70000, 60.5, "1");
		Counter counter5 = new Counter(5, "E", 50000, 40.0, "2");
		Counter counter6 = new Counter(6, "F", 50000, 40.0, "2");
		Counter counter7 = new Counter(7, "G", 70000, 62.5, "2");
		Counter counter8 = new Counter(8, "H", 40000, 30.0, "2");
		// 裝成 List 存進 Database

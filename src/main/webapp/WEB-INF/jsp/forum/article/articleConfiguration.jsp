...
.table-container {
	height: calc(100vh - 100px); /* 設置容器高度 */
	overflow: auto; /* 設置卷軸 */
}
...
<body class="sb-nav-fixed">
	...
	<main>
		...
		<div id="category-div" style="display: none;">
			<form:form id="category-add" method="POST" modelAttribute="category"
				...
				<div class="cateinput">
					...
					<form:input path="articleCategoryName" id="category"
						required="required" />
					<label for="articleCategoryPermissions">類別權限：</label> <select
						name="articleCategoryPermissions">
								...
								<td>
									<form id="edit-category-${cate.articleCategoryID}"
										...
										<input type="hidden" name="id"
											...
											name="permission"
											data-category-id="${cate.articleCategoryID}">
											<option value="1"

									...
									<div>
										<form:form action="${contextRoot}/company/updateCompany" method="PUT"
											...
											<div class="form-group">
												...
												<form:input path="companyPhone" id="companyPhone" class="form-control">
												</form:input>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<form:select path="address" id="address" class="form-control">
													<jstl:forEach items="${addresses}" var="address">
														<jstl:choose>
															<jstl:when
																test="${address.addressId == company.address.addressId}">
											...
											<div class="form-group">
												...
												<form:select path="industryCategory" id="industryCategory"
													...
													<jstl:forEach items="${industryCategories}" var="industryCategory">
														<jstl:choose>
															<jstl:when
																test="${industryCategory.industryCategoryId == company.industryCategory.industryCategoryId}">
																<form:option
																	value="${industryCategory.industryCategoryId}"
																	selected="selected">
											...
											<div class="form-group">
												...
												<form:select path="cooperationStatus" id="cooperationStatus"
													...
													<jstl:forEach items="${cooperationStatuses}"
														...
														<jstl:choose>
															<jstl:when
																test="${cooperationStatus.cooperationStatusId == company.cooperationStatus.cooperationStatusId}">
																<form:option
																	value="${cooperationStatus.cooperationStatusId}"
																	selected="selected">
											...
											<div class="form-group">
												...
												<form:select path="openingHours" id="openingHours" class="form-control">

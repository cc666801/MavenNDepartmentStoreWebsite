		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
				...
				<head>
					...
					<link rel="stylesheet" href="${contextRoot}/assetsForFrontend/store/plugins/counto/animate.css">
					<link rel="stylesheet" href="${contextRoot}/assetsForFrontend/store/plugins/aos/aos.css">
					<link rel="stylesheet"
					...
					<!-- Main Stylesheet -->
					<link href="${contextRoot}/assetsForFrontend/store/css/style.css" rel="stylesheet">
				...
				<body>
					...
					<main id="main">
						...
						<div class="text-center my-4">
							<a href="${contextRoot}/Store/Commodity/findAllComm" class="btn btn-primary mx-3">返回商品總表</a>
							<c:forEach var="findAllCate" items="${findAllCate}" varStatus="status">
								<a href="${contextRoot}/Store/Commodity/findAllCommByCate?cateId=${findAllCate.cateId}"
							...
							<%-- action="${contextRoot}/Store/Commodity/findAllCommByCate?cateId=${commodity.commCate.cateId}"
								...
								<%-- method="get"> --%>
									<%-- <input type="hidden" name="cateId" value="${commcate.cateId}"> --%>
										<%-- <button type="submit"
											class="btn btn-warning">"${commcate.cateId.cateName}"</button> --%>
																...
																<%-- <p class="card-text">商品名稱:${commodity.commName}</p>
																	...
																	<%--
																		...
																		<%-- 商品分類:${commodity.commCate.cateName} </a>
																			--%>
																			<%-- <p
																				class="card-text">商品價格:${commodity.commPrice}
																				</p> --%>
																				<!-- 							</div> -->
																				<!-- 						</div> -->
																				<!-- 					</div> -->
																						...
																						<%--
																							...
																							<%-- src="data:image/png;base64,${commodity.base64StringcommPicture}"
																								...
																								<%--
																									...
																									--%>
																									<%-- <h5
																										class="mb-0">${commodity.commName}
																										</h5> --%>
																										<!-- 												<p>商品詳細頁面</p> -->
																										<%-- <p
																											class="card-text">商品原價:${commodity.commPrice}
																											</p> --%>
																											<!-- 											</a> -->
																											<!-- 										</div> -->
																											<!-- 									</div> -->
																											...
																											<!-- 						<div class="card-body"> -->
																											<%-- <p
																												class="card-text">商品名稱:${commodity.commName}
																												</p>
																												--%>
																												<!-- 							<a -->
																												<%--
																													...
																													--%>
																													<%-- <p
																														class="card-text">商品特價:${commodity.commPrice*commodity.commDiscount}
																														</p>
																														--%>
																														<!-- 						</div> -->
																														<!-- 					</div> -->
																														<%--
																															...
																															<!-- 		5/5原版搜尋欄 -->
																															<%-- <form
																																action="${contextRoot}/Store/Commodity/findCommByName">
																																--%>
																																					...
																																					<div
																																						...
																																						<c:forEach
																																							...
																																							<div class="col-lg-4 col-6 mb-4 shuffle-item"
																																								...
																																								<div
																																									class="position-relative inner-box">
																																									<div
																																										class="image position-relative">
																																										<a
																																											href="${contextRoot}/Store/Commodity/findComm?commId=${commodity.commId}">
																																											<img src="data:image/png;base64,${commodity.base64StringcommPicture}"
																																												alt="portfolio-image"
																																								...
																																								<div
																																									...
																																									<p
																																										class="card-text">
																																										商品名稱:${commodity.commName}
																																									</p>
																																									<a
																																										href="${contextRoot}/Store/Commodity/findAllCommByCate?cateId=${commodity.commCate.cateId}">商品分類:${commodity.commCate.cateName}</a>
																																									<p
																																										class="card-text">
																																										商品特價:${commodity.commPrice*commodity.commDiscount}
																																									</p>
																																									<div
																																										class="info">
																																										<button
																																									...
																																									<div
																																										...
																																										<form
																																											...
																																											<button
																																												type="submit"
																																												class="btn btn-outline-primary">心願清單</button>
																																										</form>
																																									</div>
																																										...
																																										<div
																																											...
																																											<div
																																												...
																																												<div
																																													class="pagination">
																																													<ul
																																														class="list-inline d-block mx-auto">

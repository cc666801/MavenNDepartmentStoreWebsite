...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<h1 class="mb-3">編輯廣告類別</h1>

		<form:form modelAttribute="advertiseCate" method="put"
			action="${contextRoot}/Advertise/Adv/editAdCate">
			<form:input type="hidden" path="advertiseCateId" />
			<form:label path="advertiseCateName">廣告分類名稱</form:label>
			<form:input path="advertiseCateName" />
			<br>
			<form:label path="advertiseCateDesc">廣告分類敘述</form:label>
			<form:input path="advertiseCateDesc" />
			<br>
			<form:label path="advertiseCateMDay">廣告分類調整時間</form:label>
			<form:input path="advertiseCateMDay" readonly="true" />
			<br>
